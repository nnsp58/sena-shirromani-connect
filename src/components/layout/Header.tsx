    ...
    <header className="fixed top-0 left-0 right-0 h-20 z-50 bg-gradient-to-r from-primary to-[hsl(220,20%,18%)] shadow-lg">
      <div className="max-w-[1440px] mx-auto h-full flex items-center justify-between px-6">
        ...
        <div className="flex gap-3">
          <button className="px-6 py-2.5 text-[15px] font-semibold rounded-lg border-2 border-primary-foreground/50 text-primary-foreground bg-transparent hover:bg-primary-foreground/10 hover:border-primary-foreground transition-all duration-300">
            लॉगिन
          </button>
          <button className="px-6 py-2.5 text-[15px] font-semibold rounded-lg bg-secondary text-secondary-foreground hover:bg-accent hover:-translate-y-0.5 hover:shadow-lg transition-all duration-300">
            साइन अप
          </button>
        </div>
      </div>
